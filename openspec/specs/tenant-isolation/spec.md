...
Garantizar el aislamiento de datos entre tenants (ADR-002 row-level) mediante un repository genérico que filtra por `tenant_id` por defecto y aplica soft delete transversal; los datos nunca cruzan tenants.
