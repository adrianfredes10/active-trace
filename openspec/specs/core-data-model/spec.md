...
Definir la entidad `Tenant` raíz y los mixins base (`id` UUID, `tenant_id`, `created_at`, `updated_at`, `deleted_at`) que materializan las convenciones del modelo de datos para toda entidad de dominio.
