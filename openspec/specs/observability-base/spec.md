...
Proveer logging estructurado JSON e instrumentación OpenTelemetry inicial de la app, configurables por entorno y sin acoplar el arranque a un backend de telemetría.
