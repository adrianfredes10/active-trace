...
Definir la estructura de directorios Clean Architecture del backend, los slots transversales reservados de `core/` y la convención de tamaño de archivo, de modo que todos los changes posteriores encajen sin reorganizar el cimiento.
