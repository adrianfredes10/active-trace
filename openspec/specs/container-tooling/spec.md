...
Proveer el tooling de contenedores del backend: `Dockerfile` multi-stage (convención Easypanel) y `docker-compose.yml` con los servicios `api`, `postgres` y `worker`.
